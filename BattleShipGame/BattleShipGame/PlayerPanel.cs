...
namespace BattleShipGame
{
    ...
    class PlayerPanel : Panel
    {
        ...
        private void CreateSwitchBtn()
        {
            ...
            btn.Location = new Point(100, 10 * cellSize);
        ...
        private void CreateBtns()
        {
            ...
            Size = new Size(10 * cellSize, 13 * cellSize);
        ...
        private void RedrawBtns(List<Point> P, bool isGood, bool isBack)
        {
            ...
            if (isGood) color = Color.DarkGreen;
            else color = Color.MediumVioletRed;
